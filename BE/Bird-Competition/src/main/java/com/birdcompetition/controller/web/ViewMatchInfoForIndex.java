 ...
 * @author Admin
 */
@WebServlet(name = "ViewMatchInfoForIndex", urlPatterns = {"/IndexMatchInfo"})
public class ViewMatchInfoForIndex extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (contestId != null) {
                ...
                java.util.List<BirdContestDTO> listBird = birdContestDao.getList();
                request.setAttribute("LIST_BIRD", listBird);
            }

        } catch (SQLException ex) {
            log("ViewMatchInfoForIndex_SQL: " + ex.getMessage());
        } catch (ClassNotFoundException ex) {
            log("ViewMatchInfoForIndex_ClassNotFound: " + ex.getMessage());
        } finally {
