 ...
 * @author Danh
 */
@WebServlet(name = "PrepareCheckInServlet", urlPatterns = {"/PrepareCheckInServlet"})
public class PrepareCheckInServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<BirdContestDTO> partList = dao.getList();
            request.setAttribute("PARTICIPANT", partList);
