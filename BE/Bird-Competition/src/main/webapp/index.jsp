                            ...
                            <div class="navbar-nav mr-auto py-0">
                                ...
                                <div class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu rounded-0 m-0">
                                        ...
                                        <a href='<c:url value="/DispatchServlet?btAction=Current"/>' class="dropdown-item">Luật thi đấu</a>
                                        <a href='<c:url value="/DispatchServlet?btAction=Preparing"/>' class="dropdown-item">Feedback</a>
