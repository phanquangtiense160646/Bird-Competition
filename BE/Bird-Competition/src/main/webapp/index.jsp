<%-- 
    Document   : index.jsp
    Created on : Oct 20, 2023, 9:47:15 PM
    Author     : Admin
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <div id="bangxephang" class="container-fluid p-5">
            ...
            <div class="row g-5">
                <div class="col-lg-4 col-md-6">
                    <div class="team-item position-relative">
                        <div class="position-relative overflow-hidden rounded">
                            <img class="img-fluid w-100" src="img/daddyHuy.jpg" alt="">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="team-item position-relative">
                        <div class="position-relative overflow-hidden rounded">
                            <img class="img-fluid w-100" src="img/thuanDam.jpg" alt="">
                            <div class="team-overlay">
                                <div class="align-items-center justify-content-start">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="team-item position-relative">
                        <div class="position-relative overflow-hidden rounded">
                            <img class="img-fluid w-100" src="img/eDanh.jpg" alt="">
                            <div class="team-overlay">
                                <div class="align-items-center justify-content-start">
        ...
        <div class="col-lg-12 col-md-6 d-flex justify-content-center mt-2">
                            ...
                            <c:forEach var="scheduleDto" items="${scheduleData}" varStatus="counter">
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="bg-dark rounded text-center py-5 px-3">
                                        ...
                                        <p class="text-uppercase text-secondary mb-0">Min Point: ${scheduleDto.minPoint}</p>
                                        <p class="text-uppercase text-secondary mb-0">Max Point: ${scheduleDto.maxPoint}</p>
    ...
    <!-- Membership Start -->
    <div id="member" class="container-fluid programe position-relative px-5 mt-5" style="margin-bottom: 180px;">
        <div class="row g-5 gb-5">
            <div class="col-lg-4 col-md-6">
                <div class="bg-light rounded text-center p-5">
                    ...
                    <p>Gói 1 tháng</p>
                    <a class="text-uppercase" href="memberShip.html#registration">Tham gia ngay<i class="bi bi-arrow-right"></i></a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="bg-light rounded text-center p-5">
    ...
    <div id="news" class="container-fluid p-5">
        ...
        <div class="row g-5">
            <div class="col-lg-4">
                <div class="blog-item">
                    <a href="https://baria.baria-vungtau.gov.vn/article/?item=63944904898b51bc1d04e968c0c1ca50">
                        ...
                        <div class="bg-dark d-flex align-items-center rounded-bottom p-4">
                            ...
                            <a class="h5 text-uppercase text-light" href="https://baria.baria-vungtau.gov.vn/article/?item=63944904898b51bc1d04e968c0c1ca50">HỘI THI CHIM CHÀO MÀO ĐẤU HÓT TPBR MỞ RỘNG NĂM 2023</h4></a>
                        </div>
                    </a>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="blog-item">
                    <a href="https://baocaobang.vn/hoi-thi-dau-hot-chim-chao-mao-thanh-pho-mo-rong-nam-2023-3161421.html">
                        <div class="position-relative overflow-hidden rounded-top">
                            <img class="img-fluid" src="img/104155_104154_104153_ntv03550_14381223_16185323_16191723.jpg" alt="">
                        </div>
                        <div class="bg-dark d-flex align-items-center rounded-bottom p-4">
                            <div class="flex-shrink-0 text-center text-secondary border-end border-secondary pe-3 me-3">
                                <span>23</span>
                            ...
                            <a class="h5 text-uppercase text-light" href="https://baocaobang.vn/hoi-thi-dau-hot-chim-chao-mao-thanh-pho-mo-rong-nam-2023-3161421.html">Hội thi đấu hót chim chào mào Thành phố Cao Bằng mở rộng năm 2023</h4></a>
                        </div>
                    </a>
                </div>
            </div>
                ...
                <div class="blog-item">
                    <a href="https://www.baokiengiang.vn/le-hoi/hoi-thi-chim-hot-nghe-thuat-mo-rong-nam-2023-17028.html">
                        ...
                        <div class="bg-dark d-flex align-items-center rounded-bottom p-4">
                            ...
                            <a class="h5 text-uppercase text-light" href="https://www.baokiengiang.vn/le-hoi/hoi-thi-chim-hot-nghe-thuat-mo-rong-nam-2023-17028.html"> "Hội thi chim hót nghệ thuật mở rộng năm 2023 tại TP. Rạch Giá (Kiên Giang) </h4></a>
                        </div>
                    </a>
                </div>
            </div>
