                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0 px-lg-5">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div class="navbar-nav mr-auto py-0">
                                <a href="StartServlet" class="nav-item nav-link">Home</a>
                                <a href="SearchLeaderBoardServlet" class="nav-item nav-link active">Bảng xếp hạng</a>
                            ...
                            <tbody>
                                ...
                                <c:forEach var="i" begin="0" end="${size -1 }" step="1">
                                    ...
                                    <tr class="list__row" data-image="FE/img/thuanphuong.jpg" data-win= ${leaderboard.get(i).win} data-lose= ${leaderboard.get(i).lose} data-tie= ${leaderboard.get(i).tie} data-match= "${leaderboard.get(i).matchNumber}">
                                        ...
                                        <td class="list__cell">
                                            <span class="list__value">${leaderboard.get(i).trainer}</span>
                                            <small class="list__label">Trainer</small>
                                        </td>
                                        <td class="list__cell">
