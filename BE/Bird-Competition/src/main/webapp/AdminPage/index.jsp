<%-- 
    Document   : index.jsp
    Created on : Oct 24, 2023, 8:35:31 AM
    Author     : Admin
--%>
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="card border-left-info shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total Members
                                    </div>
                                    <div class="row no-gutters align-items-center">
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                        Total Schedules</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                        <c:set var="totalchedule" value="${requestScope.SCHEDULELIST}"/>
                                        <c:if test="${ empty totalchedule}">
                                            Rong
                                        </c:if>
                                        <c:if test="${not empty totalchedule}">
                                            <p>${totalchedule}</p>
                                        </c:if>
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                        Total Feedbacks</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                        <c:set var="totalchedule" value="${requestScope.FEEDBACK}"/>
                                        <c:if test="${ empty totalchedule}">
                                            Rong
                                        </c:if>
                                        <c:if test="${not empty totalchedule}">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                        Total Orders</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                        <c:set var="totalchedule" value="${requestScope.ORDER}"/>
                                        <c:if test="${ empty totalchedule}">
                                            Rong
                                        </c:if>
                                        <c:if test="${not empty totalchedule}">
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                        <c:set var="totalmembership" value="${requestScope.MEMBERSHIP}"/>
                                        <c:if test="${ empty totalmembership}">
                                            Rong
                                        </c:if>
                                        <c:if test="${not empty totalmembership}">
                                            <p>${totalmembership}</p>
                                        </c:if>
