                            ...
                            <div class="card-body p-4 text-black" style="background: rgba(0, 0, 0, 0.6);"    >
                                ...
                                <div class="mb-5 mt-5"  >
                                    ...
                                    <span class="centered-text">
                                        <p class="lead fw-normal mb-1 text-white">Add New Account</p>
                                    </span>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12">
                                                ...
                                                <div class="card mb-4 " style="background-color: rgba(0, 0, 0, 0.4);">
                                                    <div class="card-header text-white">New Account Details</div>
                                                    <div class="card-body">
                                                        ...
                                                        <form action="DispatchServlet" >
                                                            ...
                                                            <!-- Form Group (birdname)-->
                                                            <div class="mb-3">
                                                                <label class="small mb-1 text-white" for="inputUsername">Username</label>
                                                                <input class="form-control" type="text" placeholder="Nhập Username"
                                                                       name="username">
                                                            </div>
                                                            <!-- Form Row-->
                                                            <div class="row gx-3 mb-3">
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <input class="form-control" id="inputSpecies" type="text" placeholder="Nhập Password"
                                                                           name="password" style="background-color: white" readonly>
                                                                </div>
                                                            ...
                                                            <div class="row gx-3 mb-3">
                                                                <!-- Form Group (Species)-->
                                                                <div class="col-md-12">
                                                                    <label class="small mb-1 text-white" for="inputSpecies">Gmail</label>
                                                                    <input class="form-control" id="inputGmail" type="text" placeholder="Nhập Gmail"
                                                                           name="gmail">
                                                                </div>
                                                            ...
                                                            <div class="row gx-3 mb-3">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <label class="small mb-1 text-white" for="inputSpecies">Vai trò</label>
