                                ...
                                <div class="container-xl px-4 mt-4">
                                    ...
                                    <ul class="nav nav-pills justify-content-between">
                                        <li class="nav-item w-50">
                                            <a class="nav-link btn btn-primary py-md-3 px-md-5 me-3 active" data-bs-toggle="pill" href="#pills-1" style="color: black">Trận sắp tới</a>
                                        </li>

                                        <li class="nav-item w-50">
                                            <a class="nav-link btn btn-primary py-md-3 px-md-5 me-3" data-bs-toggle="pill" href="#pills-2" style="color: black">Trận đã đấu</a>
                                        </li>
                                    </ul>
                                    <div class="p-5">
