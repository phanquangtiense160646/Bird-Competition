...
<c:choose>
        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="img/hinh-anh-chim-chao-mao.jpg" alt="Image">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="img/chaomao-bg (2).jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h5 class="text-white text-uppercase">BIRD COMPETITION PLATFORM</h5>
                            <h1 class="display-2 text-white text-uppercase mb-md-4">Best Place To Show Us Your Birds</h1>
    ...
    <div id="schedule" class="container-fluid p-5">
                    ...
                    <div class="row g-5">
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="bg-dark rounded text-center py-5 px-3">
                                <h6 class="text-uppercase text-light mb-3"> Ngày: 23/1/2023</h6>
                                <h6 class="text-uppercase text-light mb-3"> Giờ: 8.00am - 10.00am</h6>
                                <h6 class="text-uppercase text-light mb-3"> Địa điểm: FPT</h6>
                                <h5 class="text-uppercase text-primary">Thi hót</h5>
                                ...
                                <p class="text-uppercase text-secondary mb-0" style="display: inline;">
                                    số người đăng kí: <p class="text-uppercase text-primary mb-0" style="display: inline;">10/15</p>
                                </p>
        ...
        <div class="col-lg-12 col-md-6 d-flex justify-content-center mt-3">
            <a href="FE/schedule.html" class="btn btn-primary py-3 px-5">Xem lịch thi đấu</a> 
        </div>
    </div>
    <!-- Schedule End -->
            ...
            <div class="col-lg-4">
                ...
                <a href="https://baria.baria-vungtau.gov.vn/article/?item=63944904898b51bc1d04e968c0c1ca50">
                    ...
                    <div class="bg-dark d-flex align-items-center rounded-bottom p-4">
                        ...
                        <a class="h5 text-uppercase text-light" href="">HỘI THI CHIM CHÀO MÀO ĐẤU HÓT TPBR MỞ RỘNG NĂM 2023</h4></a>
                    </div>
                </a>
                </div>
            </div>
            <div class="col-lg-4">
                ...
                <a href="https://baocaobang.vn/hoi-thi-dau-hot-chim-chao-mao-thanh-pho-mo-rong-nam-2023-3161421.html">
                    ...
                    <div class="bg-dark d-flex align-items-center rounded-bottom p-4">
                        ...
                        <a class="h5 text-uppercase text-light" href="">Hội thi đấu hót chim chào mào Thành phố Cao Bằng mở rộng năm 2023</h4></a>
                    </div>
                </a>
                </div>
            </div>
            <div class="col-lg-4">
                ...
                <a href="https://www.baokiengiang.vn/le-hoi/hoi-thi-chim-hot-nghe-thuat-mo-rong-nam-2023-17028.html">
                    ...
                    <div class="bg-dark d-flex align-items-center rounded-bottom p-4">
                        ...
                        <a class="h5 text-uppercase text-light" href=""> "Hội thi chim hót nghệ thuật mở rộng năm 2023 tại TP. Rạch Giá (Kiên Giang) </h4></a>
                    </div>
                </a>
                </div>
            </div>
