        ...
        <div class="container-fluid bg-primary p-5 bg-hero mb-5">
            <div class="row py-5">
                <div class="col-12 text-center">
                    ...
                    <a href="news.html" class="btn btn-light py-md-3 px-md-5">Blog</a>
                </div>
            </div>
        </div>
        <!-- Hero End -->
                        ...
                        <div class="col-md-6">
                            <div class="blog-item">
                                <div class="position-relative overflow-hidden rounded-top">
                                    <img class="img-fluid" src="img/e745fc8013c0cd9e94d19-b01f3211820b45b4b954bac2e79b92b9.jpg" alt="">
                                </div>
            ...
            <div class="row gx-5">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center h-100 bg-primary p-5">
                        <h4 class="text-uppercase text-white mb-4">Bản Tin</h4>
                        <h6 class="text-uppercase text-white">Đăng Ký Bản Tin</h6>
                        <p class="text-light">Đăng ký bản tin để nhận được những thông báo sớm nhất về giải đấu.</p>
                        <form action="">
                            <div class="input-group">
