                                    ...
                                    <div class="row g-5 d-flex justify-content-center">
                                        <div class="col-lg-3 col-md-4 col-sm-6  btn-register">
                                            <div class="bg-dark rounded text-center py-5 px-3">
                                                ...
                                                <!-- <button class="btn btn-primary btn-register px-5" style="margin-top: 10px;">cập nhật kết quả</button> -->
                                                <a href="MatchResult.html" class="btn btn-primary px-5 mt-2">Cập nhật kết quả</a>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-4 col-sm-6  btn-register">
                                            <div class="bg-dark rounded text-center py-5 px-3">
